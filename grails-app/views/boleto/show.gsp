...
<html>
    ...
    <body>
        ...
        <div id="show-boleto" class="content scaffold-show" role="main">
            ...
            <f:display bean="boleto" />
            <g:form resource="${this.boleto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.boleto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
